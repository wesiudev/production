  ...
  return (
    <div className="w-full mx-auto h-12 mb-6 relative">
      <div className="flex flex-row h-full items-center">
        <input
          type="text"
          className="group cursor-pointer h-full sm:w-2/4 lg:w-1/4 focus:w-1/2 ease-in duration-150 text-black bg-white  p-3 outline-none rounded-l-md placeholder:text-gray-700"
